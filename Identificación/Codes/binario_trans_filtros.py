...
modelo = tf.keras.Sequential([
    ...
    tf.keras.layers.Conv2D(8, (7, 7), activation='relu', padding='same', kernel_initializer='he_normal', input_shape=(256, 256, 1)),
    tf.keras.layers.MaxPooling2D(2,2),
    ...
    tf.keras.layers.Dense(128, activation='relu', kernel_regularizer=l2(0.001), kernel_initializer='he_normal'),
    tf.keras.layers.Dropout(0.1),
    tf.keras.layers.Dense(64, activation='relu', kernel_regularizer=l2(0.001), kernel_initializer='he_normal'),
    tf.keras.layers.Dropout(0.1),
    tf.keras.layers.Dense(16, activation='relu', kernel_regularizer=l2(0.001), kernel_initializer='he_normal'),
    tf.keras.layers.Dropout(0.1),
    tf.keras.layers.Dense(1, activation = 'sigmoid')
])
