...
modelo = tf.keras.Sequential([
    ...
    tf.keras.layers.Conv2D(8, (5, 5), activation='relu', padding='same', kernel_initializer='he_normal', input_shape = (256, 256, 1)),
    tf.keras.layers.MaxPooling2D(2,2),
    ...
    tf.keras.layers.Dense(128, activation='relu', kernel_regularizer=l2(0.01), kernel_initializer='he_normal'),
    tf.keras.layers.Dropout(0.1),
    tf.keras.layers.Dense(64, activation='relu', kernel_regularizer=l2(0.01), kernel_initializer='he_normal'),
    tf.keras.layers.Dropout(0.1),
    tf.keras.layers.Dense(16, activation='relu', kernel_regularizer=l2(0.01), kernel_initializer='he_normal'),
    tf.keras.layers.Dropout(0.1),
    tf.keras.layers.Dense(1, activation = 'sigmoid')
])
...
callbacks = [
    ...
    # tf.keras.callbacks.ReduceLROnPlateau(monitor='val_accuracy', factor=0.1, patience=5, min_lr=1e-6),
    tf.keras.callbacks.ModelCheckpoint(f'/home/tfd/mgutierr/tfm/CNN/Codigos/Modelos_Binarios_long/mejor_modelo_{n}.h5', monitor='val_accuracy', save_best_only=True, mode='max', verbose=1)
   ] 
...
plt.savefig(f'/home/tfd/mgutierr/tfm/CNN/Graficas/Longitudinal/Binario/Modelos/modelo_{n}_binario.png')
...
plt.savefig(f'/home/tfd/mgutierr/tfm/CNN/Graficas/Longitudinal/Binario/CM/CM_{n}_binario.png')
