...
modelo_diag = tf.keras.models.load_model(f'/home/tfd/mgutierr/tfm/Diagnostico/Codigos/Red/Modelos_diag_trans/mejor_modelo_filtros_{d}.keras', safe_mode=False)
...
def procesar_y_visualizar_todas(model_seg, model_diag, X_good, etiquetas_diagnostico, output_dir):
    ...
    for idx, imagen_original in enumerate(X_good):
        ...
        if coords.size > 0:
            ...
            nombre_salida = os.path.join(output_dir, f"{idx + 1}_diagnostico_filtros.png")
