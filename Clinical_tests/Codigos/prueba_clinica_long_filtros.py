...
input_dir = '/home/tfd/mgutierr/tfm/rediagnostico/long'
...
modelo_iden = tf.keras.models.load_model(f'/home/tfd/mgutierr/tfm/CNN/Codigos/Modelos_Binarios_long/mejor_modelo_filtro_{i}.h5')
...
output_dir_bad = "/home/tfd/mgutierr/tfm/Pruebas_clinicas/Identificación/Long"
output_dir_good = "/home/tfd/mgutierr/tfm/Pruebas_clinicas/Identificación/Long"
...
class_weights_dict = {'0': 0.2635284684880315, '1': 18.66359352673379, '2': 11.509097958277016, '3': 15.414132698372969}
...
model_seg = tf.keras.models.load_model(f'/home/tfd/mgutierr/tfm/U-net/Codigos/unet_long/modelo_unet_long_{s}.h5', safe_mode=False, custom_objects={'weighted_loss': weighted_loss})
...
output_dir = '/home/tfd/mgutierr/tfm/Pruebas_clinicas/Segmentación/Long'
...
modelo_diag = tf.keras.models.load_model(f'/home/tfd/mgutierr/tfm/Diagnostico/Codigos/Red/Modelos_diag_long/mejor_modelo_filtros_{d}.keras', safe_mode=False)
...
def procesar_y_visualizar_todas(model_seg, model_diag, X_good, etiquetas_diagnostico, output_dir):
    ...
    for idx, imagen_original in enumerate(X_good):
        ...
        if coords.size > 0:
            ...
            X_mediano = aplicar_filtro_mediano(recorte)
            X_contraste = filtro_contraste_adaptativo(X_mediano)
            X_contraste_fuerte = realce_adicional_contraste(X_contraste)
            recorte_normalizado = X_contraste_fuerte / 255.0
            recorte_input = np.expand_dims(recorte_normalizado, axis=(0, -1))  # Expandir a formato (1, 70, 70, 1)
            ...
            nombre_salida = os.path.join(output_dir, f"filtros_{idx + 1}_diagnostico.png")
...
output_dir = '/home/tfd/mgutierr/tfm/Pruebas_clinicas/Diagnostico/Long'
