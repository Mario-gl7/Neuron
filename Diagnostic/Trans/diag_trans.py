...
print('pixeles nervios: ', np.unique(nervios))
# print(X_nombres[270], X_nombres[515])
# print(X_drawings[270], X_drawings[515])
...
# print('X_train_diag: ', X_train_diag.unique)
...
callbacks = [
    ...
    tf.keras.callbacks.ModelCheckpoint(f'/home/tfd/mgutierr/tfm/Diagnostico/Codigos/Red/Modelos_diag_trans/mejor_modelo_filtros_{n}.keras', monitor='val_accuracy', save_best_only=True, mode='max', verbose=1)
   ] 
...
modelo.save(f'/home/tfd/mgutierr/tfm/Diagnostico/Codigos/Red/Modelos_diag_trans/diag_trans_filtros_{n}.keras')

# Guardar la arquitectura
estructura_json = modelo.to_json()
with open(f"/home/tfd/mgutierr/tfm/Diagnostico/Codigos/Red/Modelos_diag_trans/estructura_modelo_filtros_{n}.json", "w") as json_file:
...
plt.savefig(f'/home/tfd/mgutierr/tfm/Diagnostico/Procesado/Trans/Filtros/Modelos/{n}_Grafica_diag_trans.png')
...
plt.savefig(f'/home/tfd/mgutierr/tfm/Diagnostico/Procesado/Trans/Filtros/CM/{n}_CM_diag_trans.png')
