...
ruta_json_nuevo = '/home/tfd/mgutierr/tfm/Diagnostico/Trans/mod_trans_depurado.json'
ruta_imagenes_roi = '/home/tfd/mgutierr/tfm/DATA-Tunnel-Trans'
...
# Cargar las imágenes transversales (originales)
X_imagenes_trans, Y_etiquetas_trans, Y_diag, X_drawings, X_nombres = cargar_imagenes(ruta_json_nuevo, etiquetas_unicas, etiquetas_diagnostico)
...
X_roi_trans, Y_roi_trans, Y_diag_roi_trans = cargar_mascaras(ruta_json_nuevo, etiquetas_unicas)
...
n=6
model = tf.keras.models.load_model(f'/home/tfd/mgutierr/tfm/U-net/Codigos/unet_trans/modelo_unet_trans_{n}.h5', safe_mode=False, custom_objects={'weighted_loss': weighted_loss})

X_val_seg = X_validacion

# Función para realizar la predicción y guardar las máscaras
def predecir_y_guardar(model, X_imagenes, output_dir, n_clases=5):
...
mask = predecir_y_guardar(model, X_imagenes, output_dir, n_clases=5)
...
for i, (mascara, imagen) in enumerate(zip(mask_nervios, X_imagenes_trans)):
...
# Función para guardar el progreso de los filtros
...
output_dir = "/home/tfd/mgutierr/tfm/Diagnostico/Procesado/Trans"
guardar_progreso_filtros(nervios, X_mediano, X_contraste, X_contraste_fuerte, output_dir, num_imagenes=5)

# Dividimos los datos

X_train, X_validacion, Y_train, Y_validacion = train_test_split(X_final, Y_diag, test_size=0.25, random_state=seed)
...
# modelo = tf.keras.models.load_model(f'/home/tfd/mgutierr/tfm/Diagnostico/Codigos/Red/Modelos_diag_trans/mejor_modelo_{n}.keras', safe_mode=False)

# # # n=5

# # # modelo = tf.keras.models.load_model(f'/home/tfd/mgutierr/tfm/Diagnostico/Codigos/Red/Modelos_diag_trans/mejor_modelo_filtros_{n}.keras', safe_mode=False)
...
# # # # plt.savefig(f'/home/tfd/mgutierr/tfm/Diagnostico/Procesado/Trans/CM/11_CM_diag_trans.png')
# # # plt.savefig(f'/home/tfd/mgutierr/tfm/Diagnostico/Procesado/Trans/Filtros/CM/5_CM_diag_trans_filtros.png')
...
# # # Cargar las imágenes originales y el modelo
# # nombre_salida = "/home/tfd/mgutierr/tfm/Diagnostico/Procesado/Trans/0_diagnostico.png"
# # imagen_test = X_imagenes[0]  # Por ejemplo, la primera imagen
# # imagen_procesada = procesar_y_visualizar(model, modelo, imagen_test, etiquetas_diagnostico, nombre_salida)
...
# archivo_txt = "/home/tfd/mgutierr/tfm/Diagnostico/Procesado/Trans/diagnosticos_trans.txt"
...
#     nombre_salida = f"/home/tfd/mgutierr/tfm/Diagnostico/Procesado/Trans/{idx}_diagnostico.png"  # Guardar con nombre basado en el índice
